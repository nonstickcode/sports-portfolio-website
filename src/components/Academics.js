        ...
        <div className="mt-8 max-w-6xl w-fit mx-8 lg:mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start">
            ...
            <div className="w-full md:w-1/3 mr-4 text-left">
              ...
              <h2 className="text-2xl font-semibold text-gray-300 mt-8">
                ACADEMIC AWARDS
              </h2>
              <ul className="mt-4 text-gray-400">
            ...
            <div className="w-full md:w-2/3 text-left mt-8 md:mt-0">
              ...
              <h3 className="text-xl font-semibold text-gray-300 mt-8">
                Freshman Courses
              </h3>
              <ul className="list-disc list-inside mt-2 text-gray-400">
                <li>
                  Honors Algebra 2, Honors Spanish 1, Physics, English, Theology
                </li>
              ...
              <ul className="list-disc list-inside mt-2 text-gray-400">
                <li>
                  Honor Pre-Calculus, Honors Chemistry, English, AP World
                  History
                </li>
              ...
              <ul className="list-disc list-inside mt-2 text-gray-400">
                <li>
                  AP Calculus BC, AP Chemistry, AP US History, AP English,
                  Spanish 3
                </li>
              ...
              <ul className="list-disc list-inside mt-2 text-gray-400">
                <li>
                  Honors Multi-Variable Calculus, AP Physics Mechanics, AP
                  Statistics
                </li>
